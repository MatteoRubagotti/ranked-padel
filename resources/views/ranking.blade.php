...
@section('left_navbar')
    ...
    <li class="nav-item">
        <a class="nav-link active" href="{{ route('ranking') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="30"
    ...
    <div class="p-3 pt-0 mb-4" id="div-ranking">
        <div class="container-fluid py-3">
            ...
            <div class="container mb-3 bg-success" id="ranking-title">
                <span data-toggle="tooltip" title="Per visualizzare ulteriori informazioni degli altri giocatori clicca su @username">
                    <h1 class="display-3 fw-bold pt-1 text-uppercase mb-2 text-light"><img
                            src="{{ url('/') }}/svg/rank.svg" width="60" height="60"> <b>@yield('titolo')</b> </h1>
                </span>
                <script>
                    ...
                    <table class="table table-hover align-middle shadow" id="ranking-table">
                        <thead class="ranking-table-head table-dark">
                            <tr class="align-items-center">
                                <th scope="col"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                        fill="currentColor" class="bi bi-list-ol" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                            d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5z" />
                                        <path
                                            d="M1.713 11.865v-.474H2c.217 0 .363-.137.363-.317 0-.185-.158-.31-.361-.31-.223 0-.367.152-.373.31h-.59c.016-.467.373-.787.986-.787.588-.002.954.291.957.703a.595.595 0 0 1-.492.594v.033a.615.615 0 0 1 .569.631c.003.533-.502.8-1.051.8-.656 0-1-.37-1.008-.794h.582c.008.178.186.306.422.309.254 0 .424-.145.422-.35-.002-.195-.155-.348-.414-.348h-.3zm-.004-4.699h-.604v-.035c0-.408.295-.844.958-.844.583 0 .96.326.96.756 0 .389-.257.617-.476.848l-.537.572v.03h1.054V9H1.143v-.395l.957-.99c.138-.142.293-.304.293-.508 0-.18-.147-.32-.342-.32a.33.33 0 0 0-.342.338v.041zM2.564 5h-.635V2.924h-.031l-.598.42v-.567l.629-.443h.635V5z" />
                                ...
                                <th scope="col">Storico partite&ensp;<svg xmlns="http://www.w3.org/2000/svg" width="30"
                                        height="30" fill="currentColor" class="bi bi-clock-history" viewBox="0 0 20 20">
                                        <path
                                ...
                                <th scope="col">Ultime partite&ensp;<svg xmlns="http://www.w3.org/2000/svg" width="30"
                                        height="30" fill="currentColor" class="bi bi-calendar-check" viewBox="0 0 20 20">
                                        <path
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="username">
                                        <p class="m-0">
                                            <a class="btn p-0" data-bs-toggle="collapse" role="button"
                                                aria-expanded="false" data-bs-target="#collapseUser{{ $loop->index }}"
                                        ...
                                        <div class="collapse multi-collapse mt-2" id="collapseUser{{ $loop->index }}">
                                            <div class="card card-body">
                                                ...
                                                <h6 class="card-subtitle mb-2 text-muted"><img class="me-1"
                                                        src="{{ url('/') }}/img/flags/it.png" height="16" width="25">
                                                    ITALIA</h6>
                                                <ul class="list-group list-group-flush">
                                                    <li class="list-group-item"><span> Età: </span> <span
                                                            class="font-weight-lighter">{{ $user->age ?? '--' }}</span>
                                                    </li>
                                                    <li class="list-group-item">Livello: <span class="font-weight-light">
                                                            @if ($user->level == 0) <span
                                                                    class="text-info">Principiante <i
                                                                    class="bi bi-star-fill"></i></span>@elseif($user->level
                                                                ==
                                                                1) <span class="text-primary">Dilettante <i
                                                                        class="bi bi-star-fill"></i></span>
                                                            @elseif($user->level == 2) <span
                                                                    class="text-warning">Campione <i
                                                                        class="bi bi-star-fill"></i></span>
                                                            @else <span class="text-danger">Leggenda <i
                                                                        class="bi bi-star-fill"></i></span> @endif
                                                        </span>
                                                    </li>
                                                    <li class="list-group-item">Sesso: @if ($user->sex == 'm') Maschio <i
                                                            class="bi bi-gender-male"></i> @else Femmina <i
                                                                class="bi bi-gender-female"></i>@endif
                                                    </li>
                                                    <li class="list-group-item">Mano: @if ($user->hand == 'dx') Destra @else Sinistra @endif
                                                        <img src="{{ url('/') }}/svg/hand-icon.svg" height="18"
                                                            width="18">
                                                    </li>
                                                </ul>
                                            </div>
