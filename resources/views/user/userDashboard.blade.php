                ...
                <div class="card-body">
                    ...
                    <div class="container mt-2">
                        <div class="row">
                            <div class="col-8">
                                ...
                                @else
                                <img src="{{ url('/')}}/svg/profile-female.png" class="rounded mx-auto d-block"
                                    height="200" width="200" alt="Foto profilo">
                                @endif
                    ...
                    <div class="">
                        <span class=" position-absolute end-0 me-3"><button class="btn btn-primary" type="button"
                                onclick="enableEditUserProfile()"><i
                        ...
                        <form name="edit-profile" method="post" action="{{ route('user.aggiornaProfilo') }}"
                            ...
                            <div class="input-group mb-3 justify-content-center">
                                ...
                                <div class="input-group col-lg-5 col-11">
                                    ...
                                    <input type="text" class="form-control disabled text-center"
                                        placeholder="{{$user->email}}" value="{{$user->email}}" aria-label="E-mail"
                                        id="email-dashboard" name="email" disabled>
                                </div>
                            </div>

                            <b><div id="email-alert" class="text-center text-danger"></div></b>
                            ...
                            <div class="input-group mt-5 mb-3 justify-content-center">
                                ...
                                <span class="col-3 col-md-2 p-0">
                                    @if($user->hand == 'dx')
                                    <input type="text" class="form-control disabled text-center" placeholder='Destra'
                                        aria-label="Mano preferita" id="hand-dashboard" disabled>
                                    @else
                                    <input type="text" class="form-control disabled text-center" placeholder='Sinistra'
                                        aria-label="Mano preferita" id="hand-dashboard" disabled>
                                    @endif
                                </span>
                                ...
                                <span class="col-2 col-sm-2 col-md-1 mt-4 p-0 mt-sm-4 mt-md-0"><input id="age-dashboard"
                                        ...
                                        placeholder="{{$user->age}}" name="age" value="{{$user->age}}" aria-label="Age"
                                        disabled></span>
                            </div>

                            <b><div id="age-alert" class="text-center text-danger"></div></b>

                            <div class="">

                                <span class="position-absolute end-0 me-3"><button
                                        class="btn btn-outline-success text-uppercase" type="submit" onclick="event.preventDefault(); editUserProfile()"
                                        id="save-profile" hidden>
                    ...
                    <div class="justify-content-center text-center">
                        ...
                        <div class="progress mt-2 h-25">
                            <div class="progress-bar p-2 @if($levelRate == 25) bg-info @elseif($levelRate == 50) bg-primary @elseif($levelRate == 75) bg-warning @else bg-danger @endif"
                                role="progressbar" style="width: {{$levelRate}}%;" aria-valuenow="{{$levelRate}}"
