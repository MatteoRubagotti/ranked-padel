            ...
            <div class="row row-cols-12 mt-2 ps-5 pe-4" id="games_page">
                ...
                @foreach ($games as $game)
                    <div class="col-lg-4 col-12 p-3">
                        @if ($playersPerGame[$game->id] < 4) <a
                                href="{{ route('partite.partecipazione', ['idGame' => $game->id]) }}">
                            @else <a data-bs-toggle="tooltip" title="Massimo numero di giocatori!"
                                    data-bs-placement="top" id="max-players{{ $loop->index }}">
                                    <script>
                          ...
                          @elseif($playersPerGame[$game->id] <= 3) <i class="bi bi-circle-fill"
                            ...
                            @else <i class="bi bi-circle-fill" style="color: red; font-size: 25px"></i>@endif --}}
                                    ...
                                    <li class="d-flex align-items-center me-3" style="color: white;">
                                        ...
                                        <i class="bi bi-calendar2-week ms-5 me-2" style="font-size: 20px;"></i>
                                        {{ $game->date }}
